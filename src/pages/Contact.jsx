      ...
      <div className="grid grid-cols-3 md:grid-cols-3 gap-24 mt-10 mx-auto max-md:grid-cols-2 max-md:gap-4 max-md:pb-5 max-xl:gap-8 max-2xl:gap-16">
          {contactData.map((contact, index) => {
            return (
              <div
                key={index}
                className="flex flex-col items-center justify-center rounded-3xl w-[375px] h-[400px] bg-[#f9f9f9] gap-y-8 max-md:w-[auto] max-md:h-[180px] max-md:gap-y-2 max-lg:w-[165px] max-lg:h-[270px] max-lg:gap-y-4 max-xl:w-[220px] max-xl:h-[300px]  max-xl:gap-y-6 max-2xl:w-[280px]"
              >
                ...
                <div>
                  <button className="w-[240px] bg-[#7B3FE4] text-[#f9f9f9] px-[30px] py-[16px] rounded-lg text-base cursor-pointer text-center max-md:text-xs max-md:m-2 max-md:flex max-md:justify-center max-md:w-[100px] max-md:py-[3px] max-lg:text-sm max-lg:w-[115px] max-lg:py-[10px] max-lg:flex max-lg:justify-center max-xl:text-sm max-xl:w-[200px] max-xl:py-[10px] max-xl:flex max-xl:justify-center">
